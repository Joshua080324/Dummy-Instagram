    ...
    <div style={{ 
      ...
      <Container fluid className="py-4" style={{ maxWidth: '1000px' }}>
        ...
        <div className="d-flex align-items-center justify-content-between mb-4">
          ...
          <h2 className="text-white mb-0 fw-bold">{user?.username || 'Profile'}</h2>
          <Button
            variant="link"
        ...
        >
          <Card.Body className="p-4">
            <Row className="align-items-center">
              ...
              <Col xs={8}>
                <h4 className="mb-2 fw-bold">{user?.username || 'User'}</h4>
                <p className="text-muted mb-3">{user?.email || ''}</p>
                <Row className="text-center">
                  <Col xs={4}>
                    <div className="fw-bold" style={{ fontSize: '20px' }}>{posts.length}</div>
                    <div className="text-muted small">Posts</div>
                  </Col>
                  <Col xs={4}>
                    <div className="fw-bold" style={{ fontSize: '20px' }}>0</div>
        ...
        {/* Tabs */}
        <Nav variant="tabs" className="mb-4" style={{ borderBottom: '2px solid rgba(255,255,255,0.3)' }}>
          <Nav.Item>
            <Nav.Link 
              ...
              style={{
                color: activeTab === 'posts' ? '#667eea' : 'white',
                fontWeight: activeTab === 'posts' ? 'bold' : 'normal',
                borderBottom: activeTab === 'posts' ? '3px solid #667eea' : 'none',
