    ...
    apps: [
        {
            ...
            instances: "max",
            exec_mode: "cluster",
            // HANYA AKTIFKAN INI UNTUK DEBUGGING
            error_file: "logs/app-error.log", // Semua error akan masuk sini
            out_file: "logs/app-output.log", // Semua output standar akan masuk sini
